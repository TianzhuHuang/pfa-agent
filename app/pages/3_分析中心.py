...
from pfa.portfolio_valuation import (
...
if not user.get('user_id'):
    st.warning('请先登录。')
    st.stop()
render_topnav(active='analysis', user_email=user.get('email') or ('已登录' if user.get('user_id') else ''))
...
# ===================================================================
# 左右布局：左侧分析控制台 + 结果，右侧 Ask PFA 对话抽屉
# ===================================================================
